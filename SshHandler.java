...
/**
 * Based on example code provided by Jsch
...
public class SshHandler {
    ...
    static void sendFileOverToSicpop(File f){
        ...
        try {
            ...
            JSch jsch = new JSch();
            Session session = jsch.getSession("pi", "raspberrypi.local", 22);
            ...
            String rfile = "~/Sicpop/printjob.pdf";
            rfile = rfile.replace("'", "'\"'\"'");
            rfile = "'" + rfile + "'";
            String command = "scp " + (ptimestamp ? "-p" : "") + " -t " + rfile + "&& java Main -cp .:~/Sicpop/:~/Sicpop/*";
            ...
            File _lfile = new File(f.getName());
